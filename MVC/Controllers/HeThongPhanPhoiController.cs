...
namespace MVC.Controllers
{
    public class HeThongPhanPhoiController : Controller
    {
        ...
        public IActionResult Create()
           {
              var lastHTPP = _context.HeThongPhanPhois
                 .OrderByDescending(h => h.MaHTPP)
                 .FirstOrDefault();

              var gen = new MVC.Models.Process.GenCode();
                  string newCode = gen.AutoGenCode(lastHTPP?.MaHTPP, "HTPP", 4);
        ...
        var gen = new MVC.Models.Process.GenCode();
        heThongPhanPhoi.MaHTPP = gen.AutoGenCode(lastHTPP?.MaHTPP, "HTPP", 4);
